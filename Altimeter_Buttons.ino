/*  Using TFT rom Amazon, HiLetgo 2.4" ILI9341 240X320 TFT LCD Display with Touch Panel LCD for Arduino UNO MEGA2560, 
 *  will also work with ELEGOO UNO R3 2.8 Inches TFT Touch Screen with SD Card Socket w/All Technical Data in CD for 
 *  Arduino UNO R3, but the touch buttons are reversed - Baro setting arrows - UP is Down and DOWN is up.
 *  Removed Baro Knob and added UP and DN arrows. Simpler to adjust
 *  the baro while flying.
...
#ifdef FLIP_180                           // These next "if" lines affect the Touch or display? of the screen
...

{
     ...
     tft.drawRect(1, 220, 100, 90, WHITE);                   // Orig tft.drawRect(1, 220, 100, 90, WHITE);
     tft.drawRect(136, 220, 100, 90, RED);                   // Orig tft.drawRect(136, 220, 100, 90, RED);
